...
import { AlertCircle, CalendarPlus, CheckCircle2, Clock3, Cloud, CloudOff, FileCheck2, FilePlus2, MapPin, Play, RefreshCw, Sparkles } from 'lucide-react';
...
import { getEmployeeServiceReports, ReportConflictError, ReportNetworkError, ReportSessionExpiredError, saveServiceReport, uploadServiceReportPhotos, type ServiceReportRecord, type UpsertServiceReportInput } from '../services/serviceReportApi';
...
import { FieldSessionExpiredError, getLatestVehicleStock, type VehicleStockCheck } from '../services/fieldOperationsApi';
