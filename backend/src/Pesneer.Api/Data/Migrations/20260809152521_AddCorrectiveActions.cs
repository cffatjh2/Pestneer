        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AssignedAccountId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ...
                    Problem = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: false),
                    RootCause = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    ProposedAction = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: false),
                    ResponsibleParty = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Priority = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    Status = table.Column<string>(type: "TEXT", maxLength: 24, nullable: false),
                    DueDate = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    CompletedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    VerifiedAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    CustomerApprovalStatus = table.Column<string>(type: "TEXT", maxLength: 20, nullable: false),
                    CustomerApprovalAt = table.Column<DateTimeOffset>(type: "TEXT", nullable: true),
                    CustomerApprovalNote = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
                    RecurrenceKey = table.Column<string>(type: "TEXT", maxLength: 160, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    CompanyId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CorrectiveActionId = table.Column<Guid>(type: "TEXT", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CorrectiveActionEvidence_CorrectiveActions_CorrectiveActionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_CorrectiveActionHistories_CorrectiveActions_CorrectiveActionId",
                        column: x => x.CorrectiveActionId,
                        principalTable: "CorrectiveActions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CorrectiveActionEvidence_CompanyId_CorrectiveActionId_CreatedAt",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CorrectiveActionHistories_CompanyId_CorrectiveActionId_OccurredAt",
                table: "CorrectiveActionHistories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CorrectiveActions_CompanyId_CustomerId_CustomerBranchId_Status_DueDate",
                table: "CorrectiveActions",
