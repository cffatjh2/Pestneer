...
{
    /// <inheritdoc />
    public partial class AddIntegratedVehicleInventory : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedPlate = table.Column<string>(type: "TEXT", maxLength: 16, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    CompanyId = table.Column<Guid>(type: "TEXT", nullable: false),
                    VehicleStockItemId = table.Column<Guid>(type: "TEXT", nullable: false),
                    InventoryItemId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ServiceReportId = table.Column<Guid>(type: "TEXT", nullable: true),
                    PerformedByAccountId = table.Column<Guid>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VehicleStockMovements_CompanyId_VehicleStockItemId_OccurredAt",
                table: "VehicleStockMovements",
