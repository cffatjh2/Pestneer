...
{
    /// <inheritdoc />
    public partial class AddTeamVisitSessionsAndReportEmail : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NormalizedRecipientEmail = table.Column<string>(type: "TEXT", maxLength: 320, nullable: false),
                    RecipientType = table.Column<string>(type: "TEXT", maxLength: 32, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReportEmailDeliveries_ServiceReportId_NormalizedRecipientEmail",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrderVisitSessions_CompanyId_WorkOrderId_EmployeeAccountId_StartedAt",
